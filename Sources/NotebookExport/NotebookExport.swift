...
public struct NotebookExport {
    ...
    func extractExecutableSources() throws -> [CellSource] {
        return try processCells { source in
            ...
            //TODO: we might need to include an automatic import line with the library dependency
    ...
    func moduleSource(for cellSources: [CellSource]) -> String {
        let module = """
        /*
    ...
    func toPackage(inside packagePath: Path) -> ExportResult {
        ...
        do {
            ...
            for cellSource in executableSources {
                ...
                let executableSource = moduleSource(for: [cellSource])
